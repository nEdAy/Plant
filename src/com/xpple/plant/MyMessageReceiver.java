...
import com.xpple.plant.ui.MainActivity;
			...
			if (tag.equals(BmobConfig.TAG_OFFLINE)) {// 下线通知
				...
				if (fromId != null
					...
					if (TextUtils.isEmpty(tag)) {// 不携带tag标签--此可接收陌生人的消息
						...
						if (tag.equals(BmobConfig.TAG_READED)) {// 已读回执
...
//			try {
//				jo = new JSONObject(json);
//				String message = BmobJsonUtil.getString(jo, "alert");
//				BmobNotifyManager.getInstance(context).showNotify(true, true,
//						R.drawable.ic_launcher, "您收到一条来自校园二手街的官方通知！", "通知内容",
//						message, MainActivity.class);
//			} catch (JSONException ee) {
//				// TODO Auto-generated catch block
//				ee.printStackTrace();
//				BmobLog.i("parseMessage错误：" + ee.getMessage());
//			}
			//下面有接受处理类 重改
			e.printStackTrace();
